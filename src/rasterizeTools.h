 ...
 */
__host__ __device__ static
void getAABBForTriangle(const glm::vec3 tri[3], AABB &aabb) {
    aabb.min = glm::vec3(
 ...
 */
__host__ __device__ static
float calculateBarycentricCoordinateValue(const glm::vec2 &a, const glm::vec2 &b, const glm::vec2 &c, const glm::vec3 tri[3]) {
    glm::vec3 baryTri[3];
 ...
 */
__host__ __device__ static
glm::vec3 calculateBarycentricCoordinate(const glm::vec3 tri[3], const glm::vec2& point) {
